...
def form_tentpoles(data_df, cell_type, bits_per_cell):
  ...
  if (cell_type == 'STT'):
      ...
      worst_case_cell_cfg = input_defs.cell_cfgs.STTRAMCellConfig(
      ...
      best_case_cell_cfg = input_defs.cell_cfgs.PCMCellConfig(
          cell_file_path=best_case_cell_path,
          cell_area_F2=data_df.at[best_F2_per_Mb_idx, 'Cell Area [F2]'],
          read_voltage=data_df['Read Voltage [V]'].min(skipna=True),
      ...
      worst_case_cell_cfg = input_defs.cell_cfgs.PCMCellConfig(
          cell_file_path=worst_case_cell_path,
          cell_area_F2=data_df.at[worst_F2_per_Mb_idx, 'Cell Area [F2]'],
          read_voltage=data_df['Read Voltage [V]'].max(skipna=True),
    ...
    best_case_cell_cfg = input_defs.cell_cfgs.CTTCellConfig()
    worst_case_cell_cfg = input_defs.cell_cfgs.CTTCellConfig() 
 
  elif (cell_type == 'RRAM'):
      best_case_cell_cfg = input_defs.cell_cfgs.RRAMCellConfig(
          cell_file_path=best_case_cell_path,
          cell_area_F2=data_df.at[best_F2_per_Mb_idx, 'Cell Area [F2]'],
          read_voltage=data_df['Read Voltage [V]'].min(skipna=True),
          reset_pulse=data_df['RESET Speed [ns]'].min(skipna=True),
      ...
      worst_case_cell_cfg = input_defs.cell_cfgs.RRAMCellConfig(
          cell_file_path=worst_case_cell_path,
          cell_area_F2=data_df.at[worst_F2_per_Mb_idx, 'Cell Area [F2]'],
          read_voltage=data_df['Read Voltage [V]'].max(skipna=True),
          reset_pulse=data_df['RESET Speed [ns]'].max(skipna=True),
      ...
      best_case_cell_cfg = input_defs.cell_cfgs.FeFETCellConfig(
          cell_file_path=best_case_cell_path,
          cell_area_F2=data_df.at[best_F2_per_Mb_idx, 'Cell Area [F2]'], 
          set_pulse=data_df['Write Speed [ns]'].min(skipna=True),
          reset_pulse=data_df['Write Speed [ns]'].min(skipna=True),
      ...
      worst_case_cell_cfg = input_defs.cell_cfgs.FeFETCellConfig(
          cell_file_path=worst_case_cell_path,
          cell_area_F2=data_df.at[worst_F2_per_Mb_idx, 'Cell Area [F2]'],
          set_pulse=data_df['Write Speed [ns]'].min(skipna=True),
          reset_pulse=data_df['Write Speed [ns]'].min(skipna=True),
      ...
      best_case_cell_cfg = input_defs.cell_cfgs.SRAMCellConfig(
          cell_area_F2 = 146,
          cell_file_path=best_case_cell_path)
      worst_case_cell_cfg = input_defs.cell_cfgs.SRAMCellConfig(
          cell_area_F2 = 146,
          cell_file_path=worst_case_cell_path)
      best_case_cell_cfg.generate_cell_file()
      best_case_cell_cfg.append_cell_file()
...
def gen_custom_cell(cell_type, custom_cell_inputs):
  ...
  if (cell_type == 'STT'):
      ...
      cell_cfg = input_defs.cell_cfgs.PCMCellConfig(
          cell_file_path=cell_path,
         )
      if "cell_size_F2" in custom_cell_inputs:
          cell_cfg.cell_area = custom_cell_inputs["cell_size_F2"]
      ...
      cell_cfg = input_defs.cell_cfgs.RRAMCellConfig(
          cell_file_path=cell_path
         )
      if "cell_size_F2" in custom_cell_inputs:
          cell_cfg.cell_area = custom_cell_inputs["cell_size_F2"]
      ...
      cell_cfg = input_defs.cell_cfgs.FeFETCellConfig(
          cell_file_path=cell_path
         )
      if "cell_size_F2" in custom_cell_inputs:
          cell_cfg.cell_area = custom_cell_inputs["cell_size_F2"]
